...
export const metadata: Metadata = {
  title: "Pricing",
  description:
    "Every Fingrid OS is licensed per tenant with modular stacks — start with what you run today, switch on stacks as you grow. DsaOS starts lean for small team",
  ...
  return (
    <>
      ...
      <Hero
        ...
        lede="Every Fingrid OS is licensed per tenant with modular stacks — start with what you run today, switch on stacks as you grow. DsaOS starts lean for small teams; LenderOS scales to multi-entity institutions."
      />
      <CardsSection
