      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex gap-3">
              {['linkedin', 'twitter', 'github'].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center hover:bg-mint/20 hover:scale-110 transition-all duration-300"
                >
          ...
          <div>
            ...
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 px-4 py-2.5 bg-white/10 border border-white/10 rounded-xl text-sm text-white placeholder-gray-400 focus:outline-none focus:border-mint/50 focus:bg-white/15 transition-all duration-300"
              />
              <button
                type="submit"
                className="px-4 py-2.5 bg-gradient-to-r from-mint to-mint-light text-navy font-semibold text-sm rounded-xl hover:shadow-lg hover:shadow-mint/25 hover:-translate-y-0.5 transition-all duration-300"
              >
                →
              </button>
            </form>
        ...
        <div className="border-t border-white/10 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-xs">
            © {new Date().getFullYear()} Fingrid.ai. All rights reserved.
          </p>
          <div className="flex gap-6">
            <a href="#" className="text-gray-400 hover:text-mint text-xs transition-colors duration-300">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-mint text-xs transition-colors duration-300">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-mint text-xs transition-colors duration-300">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
